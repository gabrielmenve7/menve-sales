...
- `menve-sales-web/`: frontend e app Next.js (inclui rotas API).
- `menve-sales-api/`: prisma, scripts operacionais e docs técnicos.
...
Runbook detalhado: [`menve-sales-api/docs/DEPLOY.md`](menve-sales-api/docs/DEPLOY.md) (Path A — Vercel + Neon, Path B — VPS com Docker).

Resumo **Vercel:**

- Conecte o repositório Git, defina variáveis em Production (`DATABASE_URL`, `NEXTAUTH_*`, `NEXT_PUBLIC_APP_URL`, etc. — ver [`menve-sales-api/docs/DEPLOY.md`](menve-sales-api/docs/DEPLOY.md) Path A).
...
- **Multi-tenant por subdomínio:** pode exigir DNS wildcard e teste com header `Host` — ver seção em `menve-sales-api/docs/DEPLOY.md`.
- **Smoke manual pós-deploy:** [`menve-sales-api/docs/SMOKE-CHECKLIST.md`](menve-sales-api/docs/SMOKE-CHECKLIST.md).

## Webhooks WhatsApp

Checklist de Go-live (URLs públicas, Evolution/Meta): [`menve-sales-api/docs/WHATSAPP-GOLIVE.md`](menve-sales-api/docs/WHATSAPP-GOLIVE.md).
