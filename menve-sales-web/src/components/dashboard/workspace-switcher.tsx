  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          <span
            className="flex size-8 shrink-0 items-center justify-center rounded-lg bg-foreground text-[13px] font-semibold text-background dark:bg-foreground dark:text-background"
            aria-hidden
          >
      ...
      >
        <div className="border-b border-border/60 px-4 pb-4 pt-4 dark:border-border/50">
          <div className="flex gap-3">
            <span
              className="flex size-12 shrink-0 items-center justify-center rounded-xl bg-foreground text-lg font-semibold text-background dark:bg-foreground dark:text-background"
              aria-hidden
            >
              {workspaceInitial(tenant.name)}
            </span>
